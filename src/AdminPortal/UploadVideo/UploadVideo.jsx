...
const UploadVideo = ({ categories }) => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      smallDescription: Yup.string().required("Required").max(150, "Max 150 characters allowed"),
        ...
        <div className={styles.content}>
          ...
          <form onSubmit={formik.handleSubmit} className={styles.form}>
            <div className={styles.formFields}>
              ...
              <div className={styles.formGroup}>
                ...
                {formik.touched.smallDescription && formik.errors.smallDescription ? (
                  <div className={styles.error}>{formik.errors.smallDescription}</div>
                ) : null}
              </div>

              {/* Category and Subcategory Fields */}
              <div className={`${styles.formGroup} ${styles.categorySubcategory}`}>
                <div className={styles.formGroup}>
                ...
                <div className={styles.formGroup}>
                  ...
                  {formik.touched.subCategory && formik.errors.subCategory ? (
                    <div className={styles.error}>{formik.errors.subCategory}</div>
                  ) : null}
                </div>
              </div>
            ...
            {videoId && (
             ...
             {thumbnailPreview && (
              <div className={styles.preview}>
                <img src={thumbnailPreview} alt="Thumbnail Preview" width="240" height="135" />
              </div>
            )}
          </form>
